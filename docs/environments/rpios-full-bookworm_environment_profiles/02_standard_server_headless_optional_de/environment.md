# Raspberry Pi OS Full Bookworm Standard Server Headless Install with Optional Selectable DE
...
# Common Raspberry Pi OS Full Bookworm Rules

- Target OS: Raspberry Pi OS Full Bookworm.
- Package manager: `apt`.
