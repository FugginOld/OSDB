# Raspberry Pi OS Desktop Bookworm Standard Server Headless Install with Optional Selectable DE
...
# Common Raspberry Pi OS Desktop Bookworm Rules

- Target OS: Raspberry Pi OS Desktop Bookworm.
- Package manager: `apt`.
