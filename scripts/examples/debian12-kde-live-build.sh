#!/usr/bin/env bash
# ============================================================
# debian-12-kde — build-distro.sh
# Generated by https://fugginold.github.io/OSDB/
# Generator Version: 2026.04.29.1
# Generated At (UTC): 2026-05-03T04:43:13.553Z
# Builder: live-build
# ============================================================
set -euo pipefail

DISTRO_NAME="debian-12-kde"
...
FALLBACK_MIRRORS=("http://ftp.us.debian.org/debian" "http://ftp.de.debian.org/debian")
...
PRESEED_EOF
  ...
  printf '%s\n' "kde-plasma-desktop" "plasma-nm" "plasma-pa" "kscreen" "sddm" > config/package-lists/desktop.list.chroot
...
---
componentName: debian-12-kde
strings:
  productName: debian-12-kde
  shortProductName: debian-12-kde
  version: "1.0"
  versionedName: "debian-12-kde 1.0"
  bootloaderEntryName: debian-12-kde
...
PRIMARY_MIRROR="http://deb.debian.org/debian"
MIRRORS_TRIED=()
