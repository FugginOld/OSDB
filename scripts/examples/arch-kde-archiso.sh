...
# Generated At (UTC): 2026-05-03T15:09:42.298Z
# Builder: archiso
# ============================================================
set -euo pipefail
...
PRIMARY_MIRROR="https://mirror.rackspace.com/archlinux/$repo/os/$arch"
FALLBACK_MIRRORS=("https://mirrors.kernel.org/archlinux/$repo/os/$arch")
MIRRORS_TRIED=()
